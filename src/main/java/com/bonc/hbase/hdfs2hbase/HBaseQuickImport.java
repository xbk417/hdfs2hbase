...
public class HBaseQuickImport {
	
	private static final Logger LOG = LoggerFactory.getLogger(HBaseQuickImport.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(HBaseQuickImport.class);
        
        job.setMapperClass(BatchImportMapper.class);
        job.setReducerClass(BatchImportReducer.class);
        //设置map的输出，设置reduce的输出类型
