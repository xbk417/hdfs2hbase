  ...
  public static class POSIX {
    ...
    public static class CacheManipulator {
      ...
      public void posixFadviseIfPossible(String identifier,
        ...
        NativeIO2.POSIX.posixFadviseIfPossible(identifier, fd, offset,
            len, flags);
      }
  ...
  public static FileInputStream getShareDeleteFileInputStream(File f, long seekOffset)
    ...
    if (!Shell.WINDOWS) {
      ...
      FileDescriptor fd = NativeIO2.Windows.createFile(
          f.getAbsolutePath(),
          NativeIO2.Windows.GENERIC_READ,
          NativeIO2.Windows.FILE_SHARE_READ |
              NativeIO2.Windows.FILE_SHARE_WRITE |
              NativeIO2.Windows.FILE_SHARE_DELETE,
    ...
    if (!Shell.WINDOWS) {
      ...
      try {
        FileDescriptor fd = NativeIO2.POSIX.open(f.getAbsolutePath(),
            NativeIO2.POSIX.O_WRONLY | NativeIO2.POSIX.O_CREAT
                | NativeIO2.POSIX.O_EXCL, permissions);
      ...
      try {
        FileDescriptor fd = NativeIO2.Windows.createFile(f.getCanonicalPath(),
            NativeIO2.Windows.GENERIC_WRITE,
            NativeIO2.Windows.FILE_SHARE_DELETE
                | NativeIO2.Windows.FILE_SHARE_READ
                | NativeIO2.Windows.FILE_SHARE_WRITE,
